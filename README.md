...
| [`@ssv/stencil-signals`](libs/stencil-signals/README.md)                     | TC39 & Preact Signals integration — auto-reactive components with `SignalWatcherMixin`, `effect`, `derivedAsync` and more |
