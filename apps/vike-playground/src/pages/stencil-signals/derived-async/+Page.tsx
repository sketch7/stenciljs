	...
	return (
		<div className="flex flex-col gap-6">
			...
			<p className="text-xs text-[var(--color-muted-fg)]">
				<code>derivedAsync</code> from <code>@ssv/stencil-signals/extensions</code> derives an async signal that re-runs
				whenever <code>userId</code> changes. The result is an <code>AsyncResult&lt;T&gt;</code> discriminated union
				with <code>pending</code>, <code>resolved</code>, and <code>error</code> states. Passing <code>this</code> as
				host ties the signal lifecycle to the component.
			</p>
		</div>
	);
}
