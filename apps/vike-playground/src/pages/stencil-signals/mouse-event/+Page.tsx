	...
	return (
		<div className="flex flex-col gap-6">
			...
			<p className="text-xs text-[var(--color-muted-fg)]">
				...
				<code>@Listen(&apos;mousemove&apos;, {"{ target: 'window' }"})</code>. <code>useSignalWatcher()</code> re-renders
				when the signal updates — no <code>@State</code> or <code>requestUpdate()</code> in the component.
			</p>
		</div>
	);
}
